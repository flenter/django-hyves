...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.related_token'
        db.add_column('customcore_submission', 'related_token', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['social.UserAssociation']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Submission.related_token'
        db.delete_column('customcore_submission', 'related_token_id')
    ...
    models = {
        ...
        'customcore.actioncode': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 8, 8, 21, 57, 15731)'}),
        ...
        'customcore.submission': {
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 8, 8, 21, 57, 15731)'}),
            'publish_state': ('django.db.models.fields.CharField', [], {'default': "'published'", 'max_length': '50'}),
            'related_token': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['social.UserAssociation']"}),
