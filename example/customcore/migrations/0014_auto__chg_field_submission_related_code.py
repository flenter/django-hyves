...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Submission.related_code'
        db.alter_column('customcore_submission', 'related_code_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customcore.ActionCode'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Submission.related_code'
        db.alter_column('customcore_submission', 'related_code_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['customcore.ActionCode']))
    ...
    models = {
        ...
        'customcore.actioncode': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 30, 15, 53, 6, 340834)'}),
        ...
        'customcore.submission': {
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 30, 15, 53, 6, 340834)'}),
            'publish_state': ('django.db.models.fields.CharField', [], {'default': "'published'", 'max_length': '50'}),
            'related_code': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['customcore.ActionCode']", 'null': 'True'}),
