...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Submission.related_token'
        db.alter_column('customcore_submission', 'related_token_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['social.UserAssociation'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Submission.related_token'
        db.alter_column('customcore_submission', 'related_token_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['social.UserAssociation']))
    ...
    models = {
        ...
        'customcore.actioncode': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 23, 14, 53, 32, 791690)'}),
