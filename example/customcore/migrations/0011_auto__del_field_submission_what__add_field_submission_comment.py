...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('customcore_submission', 'comment', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('customcore_submission', 'comment')
    ...
    models = {
        ...
        'customcore.actioncode': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 24, 13, 38, 10, 564253)'}),
