...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.related_code'
        db.add_column('customcore_submission', 'related_code', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['customcore.ActionCode']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Submission.code'
        db.add_column('customcore_submission', 'code', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['customcore.ActionCode']), keep_default=False)

        # Deleting field 'Submission.related_code'
        db.delete_column('customcore_submission', 'related_code_id')
    ...
    models = {
        ...
        'customcore.actioncode': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 30, 15, 26, 7, 569157)'}),
        ...
        'customcore.submission': {
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 30, 15, 26, 7, 569157)'}),
            'publish_state': ('django.db.models.fields.CharField', [], {'default': "'published'", 'max_length': '50'}),
            'related_code': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['customcore.ActionCode']"}),
