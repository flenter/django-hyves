...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProfileInformation.age'
        db.delete_column('social_profileinformation', 'age')


    def backwards(self, orm):
        
        # Adding field 'ProfileInformation.age'
        db.add_column('social_profileinformation', 'age', self.gf('django.db.models.fields.CharField')(max_length=10, null=True), keep_default=False)
