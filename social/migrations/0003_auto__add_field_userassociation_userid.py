...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserAssociation.userid'
        db.add_column('social_userassociation', 'userid', self.gf('django.db.models.fields.TextField')(max_length=255, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserAssociation.userid'
        db.delete_column('social_userassociation', 'userid')
